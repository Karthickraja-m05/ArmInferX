...
class PerformixRunner:
    ...
    async def run_benchmark(self, request: PerformixRunRequest) -> PerformixRunResult:
    ...
    async def _execute_run(
        ...
        await inference_engine.generate(prompt=test_prompt, max_tokens=16, temperature=0.2)
    ...
    def _persist_result(self, result: PerformixRunResult) -> None:
        ...
        manifest_file = PERFORMIX_STORAGE_DIR / f"{result.performix_run_id}.json"
