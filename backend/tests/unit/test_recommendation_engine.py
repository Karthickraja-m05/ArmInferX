...
def test_recommendation_engine_evidence_reasoning(tmp_path: Path):
    ...
    runs = [
        {
            ...
            "config_id": "cfg-fast",
            "configuration": {"thread_count": 4, "batch_size": 128, "model_id": "qwen2.5-0.5b-instruct"},
            "metrics_summary": {
                "latency_p50_ms": 4.11,
        ...
        },
        {
            ...
            "configuration": {"thread_count": 2, "batch_size": 64, "model_id": "qwen2.5-0.5b-instruct"},
            "metrics_summary": {
                "latency_p50_ms": 4.60,
    ...
    assert "increased request throughput by 26.4%" in reasoning_text or "request throughput" in reasoning_text
